...
json.product_url api_v1_product_url(item.product_id) # Assumes a `products` endpoint exists
json.remove_item_url api_v1_cart_item_url(item.cart.id, item.id) # Generates the remove item URL
